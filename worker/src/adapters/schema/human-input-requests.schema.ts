...
export type HumanInputRequest = typeof humanInputRequestsTable.$inferSelect;
export type HumanInputRequestInsert = typeof humanInputRequestsTable.$inferInsert;
export type HumanInputStatus = 'pending' | 'resolved' | 'expired' | 'cancelled';
export type HumanInputType = 'approval' | 'form' | 'selection' | 'review' | 'acknowledge';
